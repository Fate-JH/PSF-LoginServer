...
class Flag(private val fDef: FlagDefinition, validFlagType: CarriableFlag)
  ...
  def ValidFlagType: CarriableFlag = validFlagType
...
class OwnedFlag(private val fDef: FlagDefinition, validFlagType: CarriableFlag)
  extends Amenity
    with IsAFlag {

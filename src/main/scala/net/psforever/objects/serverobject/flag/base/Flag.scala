...
class Flag(private val fDef: FlagDefinition, val ValidFlagType: CarriableFlag)
...
class OwnedFlag(private val fDef: FlagDefinition, val ValidFlagType: CarriableFlag)
  extends Amenity
    with IsAFlag {

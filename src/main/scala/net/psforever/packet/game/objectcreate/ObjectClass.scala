...
object ObjectClass {
  ...
  def selectDataCodec(objClass: Int): Codec[ConstructorData] =
    (objClass: @switch) match {
      //ammunition
      case ObjectClass.bullet_105mm                    => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.bullet_12mm                     => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.bullet_150mm                    => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.bullet_15mm                     => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.bullet_20mm                     => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.bullet_25mm                     => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.bullet_35mm                     => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.bullet_75mm                     => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.bullet_9mm                      => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.bullet_9mm_AP                   => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.ancient_ammo_combo              => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.ancient_ammo_vehicle            => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.anniversary_ammo                => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.aphelion_immolation_cannon_ammo => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.aphelion_laser_ammo             => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.aphelion_plasma_rocket_ammo     => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.aphelion_ppa_ammo               => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.aphelion_starfire_ammo          => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.armor_canister                  => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.armor_siphon_ammo               => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.bolt                            => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.burster_ammo                    => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.colossus_100mm_cannon_ammo      => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.colossus_burster_ammo           => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.colossus_chaingun_ammo          => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.colossus_cluster_bomb_ammo      => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.colossus_tank_cannon_ammo       => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.comet_ammo                      => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.dualcycler_ammo                 => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.energy_cell                     => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.energy_gun_ammo                 => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.falcon_ammo                     => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.firebird_missile                => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.flamethrower_ammo               => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.flux_cannon_thresher_battery    => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.fluxpod_ammo                    => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.frag_cartridge                  => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.frag_grenade_ammo               => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.gauss_cannon_ammo               => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.grenade                         => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.health_canister                 => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.heavy_grenade_mortar            => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.heavy_rail_beam_battery         => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.hellfire_ammo                   => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.hunter_seeker_missile           => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.jammer_cartridge                => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.jammer_grenade_ammo             => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.lancer_cartridge                => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.liberator_bomb                  => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.maelstrom_ammo                  => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.melee_ammo                      => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.mine                            => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.mine_sweeper_ammo               => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.ntu_siphon_ammo                 => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.oicw_ammo                       => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.pellet_gun_ammo                 => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.peregrine_dual_machine_gun_ammo => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.peregrine_mechhammer_ammo       => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.peregrine_particle_cannon_ammo  => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.peregrine_rocket_pod_ammo       => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.peregrine_sparrow_ammo          => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.phalanx_ammo                    => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.phoenix_missile                 => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.plasma_cartridge                => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.plasma_grenade_ammo             => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.pounder_ammo                    => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.pulse_battery                   => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.quasar_ammo                     => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.reaver_rocket                   => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.rocket                          => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.scattercannon_ammo              => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.shotgun_shell                   => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.shotgun_shell_AP                => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.six_shooter_ammo                => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.skyguard_flak_cannon_ammo       => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.sparrow_ammo                    => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.spitfire_aa_ammo                => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.spitfire_ammo                   => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.starfire_ammo                   => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.striker_missile_ammo            => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.trek_ammo                       => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.upgrade_canister                => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.wasp_gun_ammo                   => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.wasp_rocket_ammo                => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.winchester_ammo                 => ConstructorData(CommonFieldData.codec_extra, "ammo box")
      //weapons
      ...
      case ObjectClass.aphelion_armor_siphon            => ConstructorData(WeaponData.codec_bfr_arm, "siphon")
      case ObjectClass.aphelion_armor_siphon_left       => ConstructorData(WeaponData.codec_bfr_arm, "siphon")
      case ObjectClass.aphelion_armor_siphon_right      => ConstructorData(WeaponData.codec_bfr_arm, "siphon")
      case ObjectClass.aphelion_immolation_cannon       => ConstructorData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.aphelion_laser                   => ConstructorData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.aphelion_laser_left              => ConstructorData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.aphelion_laser_right             => ConstructorData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.aphelion_ntu_siphon              => ConstructorData(WeaponData.codec_bfr_arm, "siphon")
      case ObjectClass.aphelion_ntu_siphon_left         => ConstructorData(WeaponData.codec_bfr_arm, "siphon")
      case ObjectClass.aphelion_ntu_siphon_right        => ConstructorData(WeaponData.codec_bfr_arm, "siphon")
      case ObjectClass.aphelion_plasma_rocket_pod       => ConstructorData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.aphelion_ppa                     => ConstructorData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.aphelion_ppa_left                => ConstructorData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.aphelion_ppa_right               => ConstructorData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.aphelion_starfire                => ConstructorData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.aphelion_starfire_left           => ConstructorData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.aphelion_starfire_right          => ConstructorData(WeaponData.codec_bfr_arm, "weapon")
      ...
      case ObjectClass.colossus_armor_siphon            => ConstructorData(WeaponData.codec_bfr_arm, "siphon")
      case ObjectClass.colossus_armor_siphon_left       => ConstructorData(WeaponData.codec_bfr_arm, "siphon")
      case ObjectClass.colossus_armor_siphon_right      => ConstructorData(WeaponData.codec_bfr_arm, "siphon")
      case ObjectClass.colossus_burster                 => ConstructorData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.colossus_burster_left            => ConstructorData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.colossus_burster_right           => ConstructorData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.colossus_chaingun                => ConstructorData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.colossus_chaingun_left           => ConstructorData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.colossus_chaingun_right          => ConstructorData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.colossus_cluster_bomb_pod        => ConstructorData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.colossus_dual_100mm_cannons      => ConstructorData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.colossus_ntu_siphon              => ConstructorData(WeaponData.codec_bfr_arm, "siphon")
      case ObjectClass.colossus_ntu_siphon_left         => ConstructorData(WeaponData.codec_bfr_arm, "siphon")
      case ObjectClass.colossus_ntu_siphon_right        => ConstructorData(WeaponData.codec_bfr_arm, "siphon")
      case ObjectClass.colossus_tank_cannon             => ConstructorData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.colossus_tank_cannon_left        => ConstructorData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.colossus_tank_cannon_right       => ConstructorData(WeaponData.codec_bfr_arm, "weapon")
      ...
      case ObjectClass.peregrine_armor_siphon           => ConstructorData(WeaponData.codec_bfr_arm, "siphon")
      case ObjectClass.peregrine_armor_siphon_left      => ConstructorData(WeaponData.codec_bfr_arm, "siphon")
      case ObjectClass.peregrine_armor_siphon_right     => ConstructorData(WeaponData.codec_bfr_arm, "siphon")
      case ObjectClass.peregrine_dual_machine_gun       => ConstructorData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.peregrine_dual_machine_gun_left  => ConstructorData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.peregrine_dual_machine_gun_right => ConstructorData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.peregrine_dual_rocket_pods       => ConstructorData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.peregrine_mechhammer             => ConstructorData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.peregrine_mechhammer_left        => ConstructorData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.peregrine_mechhammer_right       => ConstructorData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.peregrine_ntu_siphon             => ConstructorData(WeaponData.codec_bfr_arm, "siphon")
      case ObjectClass.peregrine_ntu_siphon_left        => ConstructorData(WeaponData.codec_bfr_arm, "siphon")
      case ObjectClass.peregrine_ntu_siphon_right       => ConstructorData(WeaponData.codec_bfr_arm, "siphon")
      case ObjectClass.peregrine_particle_cannon        => ConstructorData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.peregrine_sparrow                => ConstructorData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.peregrine_sparrow_left           => ConstructorData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.peregrine_sparrow_right          => ConstructorData(WeaponData.codec_bfr_arm, "weapon")
      ...
      //medkits
      case ObjectClass.medkit           => ConstructorData(CommonFieldData.codec_extra, "medkit")
      case ObjectClass.super_armorkit   => ConstructorData(CommonFieldData.codec_extra, "repair kit")
      case ObjectClass.super_medkit     => ConstructorData(CommonFieldData.codec_extra, "super medkit")
      case ObjectClass.super_staminakit => ConstructorData(CommonFieldData.codec_extra, "stamina kit")
      //tools
      ...
      //other
      case ObjectClass.ams_order_terminal              => ConstructorData(CommonFieldData.codec_extra, "terminal")
      case ObjectClass.ams_respawn_tube                => ConstructorData(CommonFieldData.codec_extra, "terminal")
      ...
      case ObjectClass.bfr_rearm_terminal              => ConstructorData(CommonFieldData.codec_extra, "terminal")
      case ObjectClass.implant_terminal_interface      => ConstructorData(CommonFieldData.codec_extra, "implant terminal")
      case ObjectClass.lodestar_repair_terminal        => ConstructorData(CommonFieldData.codec_extra, "terminal")
      case ObjectClass.matrix_terminala                => ConstructorData(CommonFieldData.codec_extra, "terminal")
      case ObjectClass.matrix_terminalb                => ConstructorData(CommonFieldData.codec_extra, "terminal")
      case ObjectClass.matrix_terminalc                => ConstructorData(CommonFieldData.codec_extra, "terminal")
      case ObjectClass.multivehicle_rearm_terminal     => ConstructorData(CommonFieldData.codec_extra, "terminal")
      case ObjectClass.order_terminal                  => ConstructorData(CommonFieldData.codec_extra, "terminal")
      case ObjectClass.order_terminala                 => ConstructorData(CommonFieldData.codec_extra, "terminal")
      case ObjectClass.order_terminalb                 => ConstructorData(CommonFieldData.codec_extra, "terminal")
      case ObjectClass.targeting_laser_dispenser       => ConstructorData(CommonFieldData.codec_extra, "terminal")
      case ObjectClass.teleportpad_terminal            => ConstructorData(CommonFieldData.codec_extra, "terminal")
      //failure case
      case _ => defaultFailureCodec(objClass)
    }
  ...
  def selectDataDroppedCodec(objClass: Int): Codec[ConstructorData] =
    (objClass: @switch) match {
      //ammunition
      case ObjectClass.bullet_105mm                    => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.bullet_12mm                     => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.bullet_150mm                    => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.bullet_15mm                     => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.bullet_20mm                     => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.bullet_25mm                     => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.bullet_35mm                     => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.bullet_75mm                     => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.bullet_9mm                      => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.bullet_9mm_AP                   => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.ancient_ammo_combo              => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.ancient_ammo_vehicle            => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.anniversary_ammo                => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.aphelion_immolation_cannon_ammo => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.aphelion_laser_ammo             => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.aphelion_plasma_rocket_ammo     => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.aphelion_ppa_ammo               => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.aphelion_starfire_ammo          => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.armor_canister                  => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.armor_siphon_ammo               => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.bolt                            => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.burster_ammo                    => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.colossus_100mm_cannon_ammo      => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.colossus_burster_ammo           => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.colossus_chaingun_ammo          => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.colossus_cluster_bomb_ammo      => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.colossus_tank_cannon_ammo       => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.comet_ammo                      => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.dualcycler_ammo                 => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.energy_cell                     => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.energy_gun_ammo                 => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.falcon_ammo                     => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.firebird_missile                => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.flamethrower_ammo               => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.flux_cannon_thresher_battery    => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.fluxpod_ammo                    => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.frag_cartridge                  => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.gauss_cannon_ammo               => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.grenade                         => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.health_canister                 => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.heavy_grenade_mortar            => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.heavy_rail_beam_battery         => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.hellfire_ammo                   => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.hunter_seeker_missile           => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.jammer_cartridge                => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.lancer_cartridge                => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.liberator_bomb                  => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.maelstrom_ammo                  => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.melee_ammo                      => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.mine                            => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.mine_sweeper_ammo               => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.ntu_siphon_ammo                 => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.oicw_ammo                       => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.pellet_gun_ammo                 => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.peregrine_dual_machine_gun_ammo => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.peregrine_mechhammer_ammo       => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.peregrine_particle_cannon_ammo  => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.peregrine_rocket_pod_ammo       => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.peregrine_sparrow_ammo          => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.phalanx_ammo                    => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.phoenix_missile                 => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.plasma_cartridge                => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.pounder_ammo                    => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.pulse_battery                   => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.quasar_ammo                     => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.reaver_rocket                   => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.rocket                          => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.scattercannon_ammo              => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.shotgun_shell                   => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.shotgun_shell_AP                => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.six_shooter_ammo                => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.skyguard_flak_cannon_ammo       => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.sparrow_ammo                    => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.spitfire_aa_ammo                => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.spitfire_ammo                   => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.starfire_ammo                   => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.striker_missile_ammo            => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.upgrade_canister                => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.wasp_gun_ammo                   => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.wasp_rocket_ammo                => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      case ObjectClass.winchester_ammo                 => DroppedItemData(CommonFieldData.codec_extra, "ammo box")
      //weapons
      ...
      case ObjectClass.aphelion_immolation_cannon      => DroppedItemData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.aphelion_armor_siphon           => DroppedItemData(WeaponData.codec_bfr_arm, "siphon")
      case ObjectClass.aphelion_armor_siphon_left      => DroppedItemData(WeaponData.codec_bfr_arm, "siphon")
      case ObjectClass.aphelion_armor_siphon_right     => DroppedItemData(WeaponData.codec_bfr_arm, "siphon")
      case ObjectClass.aphelion_laser                  => DroppedItemData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.aphelion_laser_left             => DroppedItemData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.aphelion_laser_right            => DroppedItemData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.aphelion_ntu_siphon             => DroppedItemData(WeaponData.codec_bfr_arm, "siphon")
      case ObjectClass.aphelion_ntu_siphon_left        => DroppedItemData(WeaponData.codec_bfr_arm, "siphon")
      case ObjectClass.aphelion_ntu_siphon_right       => DroppedItemData(WeaponData.codec_bfr_arm, "siphon")
      case ObjectClass.aphelion_plasma_rocket_pod      => DroppedItemData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.aphelion_ppa                    => DroppedItemData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.aphelion_ppa_left               => DroppedItemData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.aphelion_ppa_right              => DroppedItemData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.aphelion_starfire               => DroppedItemData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.aphelion_starfire_left          => DroppedItemData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.aphelion_starfire_right         => DroppedItemData(WeaponData.codec_bfr_arm, "weapon")
      ...
      case ObjectClass.colossus_armor_siphon           => DroppedItemData(WeaponData.codec_bfr_arm, "siphon")
      case ObjectClass.colossus_armor_siphon_left      => DroppedItemData(WeaponData.codec_bfr_arm, "siphon")
      case ObjectClass.colossus_armor_siphon_right     => DroppedItemData(WeaponData.codec_bfr_arm, "siphon")
      case ObjectClass.colossus_burster                => DroppedItemData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.colossus_burster_left           => DroppedItemData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.colossus_burster_right          => DroppedItemData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.colossus_chaingun_left          => DroppedItemData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.colossus_chaingun_right         => DroppedItemData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.colossus_cluster_bomb_pod       => DroppedItemData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.colossus_dual_100mm_cannons     => DroppedItemData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.colossus_ntu_siphon             => DroppedItemData(WeaponData.codec_bfr_arm, "siphon")
      case ObjectClass.colossus_ntu_siphon_left        => DroppedItemData(WeaponData.codec_bfr_arm, "siphon")
      case ObjectClass.colossus_ntu_siphon_right       => DroppedItemData(WeaponData.codec_bfr_arm, "siphon")
      case ObjectClass.colossus_tank_cannon            => DroppedItemData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.colossus_tank_cannon_left       => DroppedItemData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.colossus_tank_cannon_right      => DroppedItemData(WeaponData.codec_bfr_arm, "weapon")
      ...
      case ObjectClass.peregrine_armor_siphon           => DroppedItemData(WeaponData.codec_bfr_arm, "siphon")
      case ObjectClass.peregrine_armor_siphon_left      => DroppedItemData(WeaponData.codec_bfr_arm, "siphon")
      case ObjectClass.peregrine_armor_siphon_right     => DroppedItemData(WeaponData.codec_bfr_arm, "siphon")
      case ObjectClass.peregrine_dual_machine_gun       => DroppedItemData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.peregrine_dual_machine_gun_left  => DroppedItemData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.peregrine_dual_machine_gun_right => DroppedItemData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.peregrine_dual_rocket_pods       => DroppedItemData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.peregrine_mechhammer             => DroppedItemData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.peregrine_mechhammer_left        => DroppedItemData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.peregrine_mechhammer_right       => DroppedItemData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.peregrine_ntu_siphon             => DroppedItemData(WeaponData.codec_bfr_arm, "siphon")
      case ObjectClass.peregrine_ntu_siphon_left        => DroppedItemData(WeaponData.codec_bfr_arm, "siphon")
      case ObjectClass.peregrine_ntu_siphon_right       => DroppedItemData(WeaponData.codec_bfr_arm, "siphon")
      case ObjectClass.peregrine_particle_cannon        => DroppedItemData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.peregrine_sparrow                => DroppedItemData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.peregrine_sparrow_left           => DroppedItemData(WeaponData.codec_bfr_arm, "weapon")
      case ObjectClass.peregrine_sparrow_right          => DroppedItemData(WeaponData.codec_bfr_arm, "weapon")
      ...
      //medkits
      case ObjectClass.medkit           => DroppedItemData(CommonFieldData.codec_extra, "medkit")
      case ObjectClass.super_armorkit   => DroppedItemData(CommonFieldData.codec_extra, "repair kit")
      case ObjectClass.super_medkit     => DroppedItemData(CommonFieldData.codec_extra, "super medkit")
      case ObjectClass.super_staminakit => DroppedItemData(CommonFieldData.codec_extra, "stamina kit")
      //tools
      ...
      //other
      case ObjectClass.ams_respawn_tube                => DroppedItemData(CommonFieldData.codec_extra, "terminal")
      ...
      case ObjectClass.matrix_terminala                => DroppedItemData(CommonFieldData.codec_extra, "terminal")
      case ObjectClass.matrix_terminalb                => DroppedItemData(CommonFieldData.codec_extra, "terminal")
      case ObjectClass.matrix_terminalc                => DroppedItemData(CommonFieldData.codec_extra, "terminal")

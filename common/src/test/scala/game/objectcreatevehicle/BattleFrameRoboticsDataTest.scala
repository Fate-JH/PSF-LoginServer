...
class BattleFrameRoboticsDataTest extends Specification {
  val string_aphelion = hex"17 80 02 00 00 AA 0B F0 15 EB 1C FE C3 30 90 40 00 00 E4 40 00 0F FF F0 00 00 F2 08 18 CC 13 C0 60 B2 00 00 00 10 11 94 2A 00 C0 64 00 00 1A 04 D8 0C 1E 40 00 00 02 02 32 85 60 18 0C 80 00 03 10 99 01 84 C8 00 00 00 40 46 10 CE 03 01 90 00 00"

  "Battle Frame Robotics" should {
    "decode (aphelion)" in {
      PacketCoding.DecodePacket(string_aphelion).require match {
        case ObjectCreateMessage(len, cls, guid, parent, data) =>
          ...
          data match {
            case BattleFrameRoboticsData(pos, vdata, health, shields, unk1, unk2, no_mount_points, drive_state, proper_anim, unk3, show_shield, Some(inv)) =>

...
//      case ObjectClass.phantasm_12mm_machinegun => ConstructorData(DetailedWeaponData.codec, "weapon")
  ...
  def selectDataCodec(objClass : Int) : Codec[ConstructorData] =
    (objClass : @switch) match {
      ...
      case ObjectClass.aphelion_armor_siphon => ConstructorData(WeaponData.codec2, "weapon")
      case ObjectClass.aphelion_armor_siphon_left => ConstructorData(WeaponData.codec2, "weapon")
      case ObjectClass.aphelion_armor_siphon_right => ConstructorData(WeaponData.codec2, "weapon")
      ...
      case ObjectClass.aphelion_ntu_siphon => ConstructorData(WeaponData.codec2, "weapon")
      case ObjectClass.aphelion_ntu_siphon_left => ConstructorData(WeaponData.codec2, "weapon")
      case ObjectClass.aphelion_ntu_siphon_right => ConstructorData(WeaponData.codec2, "weapon")

    ...
    case VehicleServiceMessage(forChannel, action) =>
      action match {
        ...
        case VehicleAction.FrameVehicleState(player_guid, vehicle_guid, unk1, pos, orient, vel, unk2, unk3, unk4, is_crouched, unk6, unk7, unk8, unk9, unkA) =>
          VehicleEvents.publish(
            VehicleServiceResponse(s"/$forChannel/Vehicle", player_guid,
              VehicleResponse.FrameVehicleState(vehicle_guid, unk1, pos, orient, vel, unk2, unk3, unk4, is_crouched, unk6, unk7, unk8, unk9, unkA)
            )
          )
